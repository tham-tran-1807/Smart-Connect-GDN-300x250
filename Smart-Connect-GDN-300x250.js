...
lib.ssMetadata = [
		{name:"Smart_Connect_GDN_300x250_atlas_1", frames: [[906,0,50,50],[0,0,300,250],[302,0,300,250],[604,0,300,250],[0,252,300,250],[302,252,300,250],[604,252,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Smart_Connect_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.SmartConnectGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(313).call(this.frame_313).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(312).to({_off:false},0).wait(38));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(300).to({_off:false},0).to({x:10.35,y:11},12).wait(38));
	...
	// Layer_6
	this.instance = new lib.Frame6();
	this.instance.setTransform(0,1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300).to({_off:false},0).wait(50));

	// Layer_5
	this.instance_1 = new lib.Frame5();
	this.instance_1.setTransform(0,1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(240).to({_off:false},0).to({_off:true},60).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(180).to({_off:false},0).to({_off:true},60).wait(110));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(120).to({_off:false},0).to({_off:true},60).wait(170));

	// Layer_2
	this.instance_4 = new lib.Frame2();
	this.instance_4.setTransform(0,1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(60).to({_off:false},0).to({_off:true},60).wait(230));

	// Layer_1
	this.instance_5 = new lib.Frame1();
	this.instance_5.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},60).wait(290));
...
// library properties:
lib.properties = {
	id: 'D93D9BB0C0854D4980A144F6880FD22B',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Smart_Connect_GDN_300x250_atlas_1.png", id:"Smart_Connect_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['D93D9BB0C0854D4980A144F6880FD22B'] = {
